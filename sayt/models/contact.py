...
class Contact(models.Model):
    phone_mobile = models.CharField('Telefon raqam shaxsiy', max_length=25, null=True, blank=True)
    phone_clinica = models.CharField('Telefon raqam clinica', max_length=25, null=True, blank=True)
